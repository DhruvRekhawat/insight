  ...
  return (
    <main>
      <div className="flex flex-col justify-center items-start  p-4">
        <h1 className="text-2xl md:text-4xl font-bold">ICSE</h1>
        <p className='m-4'>
          The ICSE Revision Notes are curated for the ICSE
          aspirants who are aspiring to excel in their ICSE exams. These
          revision notes will justify the preparation of the students and will
          help them to do a quick study before the examination day. The ICSE
