  ...
  return (
    <main>
      <div className="flex flex-col justify-center items-start  p-4">
        <h1 className="text-2xl md:text-4xl font-bold">CBSE </h1>
        <p className='m-4'>
          The CBSE Revision Notes are curated for the CBSE
          aspirants who are aspiring to excel in their CBSE exams. These
          revision notes will justify the preparation of the students and will
          help them to do a quick study before the examination day. The CBSE
