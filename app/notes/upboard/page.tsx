  ...
  return (
    <main>
      <div className="flex flex-col justify-center items-start  p-4">
        <h1 className="text-2xl md:text-4xl font-bold">UP Boards </h1>
        <p className='m-4'>
          The UP Board Revision Notes are curated for the UP Board
          aspirants who are aspiring to excel in their UP Board exams. These
          revision notes will justify the preparation of the students and will
          help them to do a quick study before the examination day. The UP Board
