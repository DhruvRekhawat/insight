...
<Carousel opts={{loop:true}} className='md:w-full w-64'>
  <CarouselContent>
    ...
    <CarouselItem className="md:basis-1/3 w-32"><Card className='flex flex-col justify-center items-center'><CardTitle className='p-8 pb-0'>Mamta Gupta</CardTitle><CardContent className='flex flex-col justify-center items-center'><div className='flex m-4 gap-1'><Star className='text-yellow-400'></Star><Star className='text-yellow-400'></Star><Star className='text-yellow-400'></Star><Star className='text-yellow-400'></Star><Star className='text-yellow-400'></Star></div><p>Best ever coaching....well xperienced staff...knowledgeable faculty...ambience well maintained...... Join insight and get assured ur result......
